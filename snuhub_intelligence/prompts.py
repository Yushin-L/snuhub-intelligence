...
class Prompts:
    ...
    def generic_chat_prompt(model_provider: str, model_name: str) -> str:
        return CHAT_SYSTEM_PROMPT.format(AI_ASSISTANT_NAME="Snuhub Intelligence", IDE_NAME=IDE_NAME, OS_TYPE=OS_TYPE, MODEL_NAME=model_name, MODEL_PROVIDER=model_provider)
