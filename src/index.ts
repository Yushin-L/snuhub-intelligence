...
namespace CommandIDs {
  export const chatuserInput = 'snuhub-intelligence:chat-user-input';
  export const insertAtCursor = 'snuhub-intelligence:insert-at-cursor';
  export const addCodeAsNewCell = 'snuhub-intelligence:add-code-as-new-cell';
  export const createNewFile = 'snuhub-intelligence:create-new-file';
  export const createNewNotebookFromPython =
    'snuhub-intelligence:create-new-notebook-from-py';
  export const addCodeCellToNotebook =
    'snuhub-intelligence:add-code-cell-to-notebook';
  export const addMarkdownCellToNotebook =
    'snuhub-intelligence:add-markdown-cell-to-notebook';
  export const editorGenerateCode =
    'snuhub-intelligence:editor-generate-code';
  export const editorExplainThisCode =
    'snuhub-intelligence:editor-explain-this-code';
  export const editorFixThisCode = 'snuhub-intelligence:editor-fix-this-code';
  export const editorExplainThisOutput =
    'snuhub-intelligence:editor-explain-this-output';
  export const editorTroubleshootThisOutput =
    'snuhub-intelligence:editor-troubleshoot-this-output';
  ...
  export const openConfigurationDialog =
    'snuhub-intelligence:open-configuration-dialog';
  export const addMarkdownCellToActiveNotebook =
    'snuhub-intelligence:add-markdown-cell-to-active-notebook';
  export const addCodeCellToActiveNotebook =
    'snuhub-intelligence:add-code-cell-to-active-notebook';
  export const deleteCellAtIndex = 'snuhub-intelligence:delete-cell-at-index';
  export const insertCellAtIndex = 'snuhub-intelligence:insert-cell-at-index';
  export const getCellTypeAndSource =
    'snuhub-intelligence:get-cell-type-and-source';
  export const setCellTypeAndSource =
    'snuhub-intelligence:set-cell-type-and-source';
  export const getNumberOfCells = 'snuhub-intelligence:get-number-of-cells';
  export const getCellOutput = 'snuhub-intelligence:get-cell-output';
  export const runCellAtIndex = 'snuhub-intelligence:run-cell-at-index';
  export const getCurrentFileContent =
    'snuhub-intelligence:get-current-file-content';
  export const setCurrentFileContent =
    'snuhub-intelligence:set-current-file-content';
}

const DOCUMENT_WATCH_INTERVAL = 1000;
const MAX_TOKENS = 4096;
const githubCopilotIcon = new LabIcon({
  name: 'snuhub-intelligence:github-copilot-icon',
  svgstr: copilotSvgstr
});

const sparkleIcon = new LabIcon({
  name: 'snuhub-intelligence:sparkles-icon',
  ...
  implements IInlineCompletionProvider<IInlineCompletionItem>
{
  ...
  get identifier(): string {
    return '@snuhub-intelligence/snuhub-intelligence';
  }
...
/**
 * Initialization data for the @snuhub-intelligence/snuhub-intelligence extension.
 */
const plugin: JupyterFrontEndPlugin<ISnuhubIntelligence> = {
  ...
  activate: async (
    ...
    console.log(
      'JupyterLab extension @snuhub-intelligence/snuhub-intelligence is activated!'
    );
    ...
    const extensionService: ISnuhubIntelligence = {
      registerTelemetryListener: (listener: ITelemetryListener) => {
    ...
    if (settingRegistry) {
      settingRegistry
        ...
        .catch(reason => {
          console.error(
            'Failed to load settings for @snuhub-intelligence/snuhub-intelligence.',
            reason
          );
        });
    }
    ...
    if (statusBar) {
      ...
      statusBar.registerStatusItem(
        'snuhub-intelligence:github-copilot-status',
        {
